def get_multiqa_instruction(MAX_SEARCH_LIMIT: int) -> str:
    return (
...
def get_math_instruction(MAX_SEARCH_LIMIT: int) -> str:
    return (
        "You are a reasoning assistant with the ability to perform web searches to help "
        "you answer the user's question accurately. You have special tools:\n\n"
        "- To perform a search: write <|begin_search_query|> your query here <|end_search_query|>.\n"
...
def get_task_instruction_openqa(question: str) -> str:
    user_prompt = (
...
def get_task_instruction_math(question: str) -> str:
    user_prompt = (
